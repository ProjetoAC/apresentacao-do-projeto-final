<%-- 
    Document   : login_eletricista
    Created on : 22/10/2016, 17:02:33
    Author     : ADM
--%>
            ...
            <section>
                ...
                <div align="center">
                    ...
                    <div class="coluna col7 contato login">
                        ...
                        <form action="Login_eletricista_Servlet" method="post">
                            <label>Usuário:</label>
                            <input name="login_usuario_eletricista">
                            <br>
                            <label>Senha:</label>
