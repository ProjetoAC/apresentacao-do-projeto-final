<%-- 
    Document   : cadastro_eletricista
    Created on : 22/10/2016, 16:55:01
    Author     : ADM
--%>
...
<html>
    ...
    <head>
        ...
        <title>Cadastro Eletricista</title>
    ...
    <body>
                    ...
                    <div class="coluna col8">
                        <nav>
                            <ul class="menu inline sem-marcador">
                                ...
                                <li><a href="index_1.jsp" target="_blank" >Home &raquo;</a></li>
                                <li><a href="listar_historico_eletricista.jsp" target="_blank" >Histórico &raquo;</a></li>
                                <li><a href="listar_eletricista.jsp" target="_blank" >Eletricista &raquo;</a></li>
                                <li><a href="pendencia_eletricista.jsp" target="_blank" >Pendência &raquo;</a></li>
                            </ul>
                        </nav>
                    </div>
                </header>
        ...
        <section>
            ...
            <div  class="coluna col7 contato">
                ...
                <h4 style="color:#FF0000">Cadastro Eletricista</h4>
                <form action="Salvar_eletricista_Servlet" method="post"> 
                    <label>Codigo:</label>
                    <input placeholder="verificar codigo" name="codigo_eletricista">
                    <label>Nome:</label>
                    <input name="nome_eletricista">
                    <label>Avicultor:</label>
                    <input name="nome_avicultor">
                    <label>E-mail:</label>
                    <input name="email_eletricista">
                    <label>Telefone Residêncial:</label>
                    <input name="telefone_eletricista">
                    <label>Telefone Celular:</label>
                    <input name="celular_eletricista">
                    <label>Login/Usuário</label>
                    <input placeholder="escreva seu nome de login/usuário até 15 letras" name="login_usuario_eletricista">
                    <label>Senha:</label>
                    <input name="senha_eletricista" type="password" >
                    <label>Cidade:</label>
