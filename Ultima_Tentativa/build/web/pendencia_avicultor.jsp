<%-- 
    Document   : pendencia_avicultor
    Created on : 22/10/2016, 18:04:27
    Author     : ADM
--%>
...
<html>
    <head>
        ...
        <title>Pendência Avicultor</title>
    ...
    <body>
        ...
        <div class="linha">
            <section>
                ...
                <div class="coluna col7 contato">
                    ...
                    <h4 style="color:#FF0000">Pendência Avicultor</h4>


                   <!-- <form action="Salvar_Pendencia_Servlet" method="post">   -->
                      <form action="Salvar_Historico_Avicultor_Servlet" method="post"> 
                            
                            <label>Codigo do Serviço:</label>
                            <input placeholder="verificar codigo" name="codigo_historico_avicultor">
                            <br> 
      ...
      <!-- type date-->     <input type="date" name="data_inicio" style="width:150px;">
